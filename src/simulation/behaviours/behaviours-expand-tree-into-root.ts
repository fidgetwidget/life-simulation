...
//           return val !== Elements.ROOTS && val !== Elements.TREE;
//         });
...
//       (counts[Elements.TREE] == null || counts[Elements.TREE] < 9),
//     // roots become tree
//     action: ({ world, chunk }) => {
//       const rootsIndexes = chunk.indexes.filter(
//         (i) => world.get(i) === Elements.ROOTS,
...
//         world.set(randomRoot, Elements.SAPLING);
//       }
//     },
//   },
// ];
